...
# # Displays the parameters used in the latest roll
# screen roll_desc(roll_description):
#     tag roll_display
#     modal False
#
#     window id "roll_desc_panel" align (0.9, 0.7) xysize (400, 50) padding (5, 5):
#         style_prefix "codex_panel"
#         background Frame("gui/nvl.png", 5, 5, 5, 5)
#         modal False
#
#         label _("fuck you") text_align "left"
